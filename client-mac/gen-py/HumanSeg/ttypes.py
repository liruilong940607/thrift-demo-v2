...
class MSG:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'imageid', None, None, ), # 1
    (2, TType.STRING, 'image', None, None, ), # 2
  )

  def __init__(self, imageid=None, image=None,):
  ...
  def write(self, oprot):
    ...
    if self.imageid is not None:
      oprot.writeFieldBegin('imageid', TType.I32, 1)
      oprot.writeI32(self.imageid)
      oprot.writeFieldEnd()
